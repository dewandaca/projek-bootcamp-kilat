          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            {!!user && (
              <Link
                to="/create"
                onClick={() => setMenuOpen(false)}
                className="text-white text-xl mb-4 font-semibold px-4 py-2 rounded-md transition-colors duration-300 hover:text-[#6D4C41] hover:bg-amber-50"
              >
                Tambah Resep
              </Link>
            )}
            <div className="mt-4">
              {user ? (
                ...
                <button
                  onClick={signInWithGoogle}
                  className="text-white mb-4 text-xl px-4 py-2 rounded cursor-pointer font-semibold bg-[#AB886D] transition-all duration-300 hover:bg-[#8F6A50] hover:ring-[#AB886D] hover:ring-2"
                >
                  Login with Google
                </button>
              )}
